...
public class AdapterListProgress_PengerjaanvClient extends RecyclerView.Adapter<AdapterListProgress_PengerjaanvClient.CustomHolderView> {
    private LayoutInflater mInflater;
    Context context;
    ArrayList<Lelang> lelangs;

    public AdapterListProgress_PengerjaanvClient(Context context) {
    ...
    public CustomHolderView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View v = inflater.inflate(R.layout.item_pengerjaan, viewGroup, false);
        AdapterListProgress_PengerjaanvClient.CustomHolderView vh = new AdapterListProgress_PengerjaanvClient.CustomHolderView(v);
        return vh;
    }
